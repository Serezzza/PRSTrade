...
'			Me.btnReccurrence.Click += New System.EventHandler(Me.btnAddRec_Click);
			...
			' dtStart
			' 
            Me.dtStart.EditValue = New System.DateTime(2010, 11, 25, 0, 0, 0, 0)
...
'			Me.dtStart.EditValueChanged += New System.EventHandler(Me.dtStart_EditValueChanged);
			...
			' dtEnd
			' 
            Me.dtEnd.EditValue = New System.DateTime(2010, 11, 25, 0, 0, 0, 0)
...
'			Me.checkAllDay.CheckedChanged += New System.EventHandler(Me.checkAllDay_CheckedChanged);
			...
			Me.Controls.AddRange(New System.Windows.Forms.Control() { Me.checkAllDay, Me.timeEnd, Me.timeStart, Me.dtEnd, Me.dtStart, Me.txCustomStatus, Me.txCustomName, Me.lblCustomStatus, Me.lblCustomName, Me.lblEnd, Me.lblStart, Me.lblLabel, Me.lblStatus, Me.edStatus, Me.edLabel, Me.txSubject, Me.lblSubject, Me.btnReccurrence, Me.btnCancel, Me.btnOK})
