...
Namespace DevExpress.XtraScheduler.Demos
	Public Partial Class ColorSchemasEditForm
        ...
        Private fColorSchemas As SchedulerColorSchemaCollection

		Public Sub New(ByVal lColorSchemas As SchedulerColorSchemaCollection, ByVal parent As Form)
			'
		...
		End Sub
		Public ReadOnly Property ColorSchemas() As SchedulerColorSchemaCollection
			Get
