...
#End Region
        ...
        Private Sub Import()
            ...
            TryCast(importer, ISupportCalendarFolders).CalendarFolderName = CalendarName
            ...
            Finally
                AfterImport()
                Windows.Forms.Cursor.Current = oldCur
            End Try
        End Sub
        ...
        Private Sub importer_AppointmentImporting(ByVal sender As Object, ByVal e As AppointmentImportingEventArgs)
            ...
            ProgressBarControl1.Position = ProgressBarControl1.Position + 1
            ProgressBarControl1.Update()

            Dim cancel As Boolean
            If args.OutlookAppointment.IsRecurring Then
