   ...
   Me.carUsageImages = ImageHelper.CreateImageCollectionFromResources("car_usage_types.png", System.Reflection.Assembly.GetExecutingAssembly(), New Size(16, 16))
		...
		Private Sub dayViewTimeRuler1_CustomDrawDayViewTimeRuler(ByVal sender As Object, ByVal e As CustomDrawObjectEventArgs) Handles dayViewTimeRuler1.CustomDrawDayViewTimeRuler
			...
			Using sf As StringFormat = New StringFormat()
				...
				e.Cache.DrawVString(SchedulerTimeZoneHelper.Instance.CurrentTimeZone.DisplayName, e.Cache.GetFont(New Font(Font.FontFamily, 20, FontStyle.Bold), FontStyle.Bold), e.Cache.GetSolidBrush(Color.Gray), e.Bounds, sf, -90)
