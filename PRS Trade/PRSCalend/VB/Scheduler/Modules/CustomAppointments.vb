...
Namespace DevExpress.XtraScheduler.Demos
	Public Partial Class CustomAppointmentsModule
		...
		Public Sub New()
            Me.fCustomImages = DevExpress.Utils.Controls.ImageHelper.CreateImageCollectionFromResources("appointment_icons.png", System.Reflection.Assembly.GetExecutingAssembly(), New Size(15, 15))
        ...
        Private Sub UpdateControls()
            ...
            If Not schedulerControl.AppointmentImages Is Nothing Then
                rgrpAptImages.SelectedIndex = 1
            Else
                rgrpAptImages.SelectedIndex = 0
            End If
        End Sub
		...
		Private Sub chkCustomImages_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
			If IsExternalAppointmentImages Then
				schedulerControl.AppointmentImages = Me.imAppointmentIcons
			Else
				schedulerControl.AppointmentImages = Nothing
			End If
		End Sub
		Private Sub chkToolTip_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkToolTip.CheckedChanged
			If chkToolTip.Checked Then
				schedulerControl.ToolTipController = Me.toolTipController1
			Else
				schedulerControl.ToolTipController = Nothing
			End If
		End Sub
