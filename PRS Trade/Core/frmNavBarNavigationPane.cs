...
namespace DevExpress.XtraNavBar.Demos {
	...
	public partial class frmNavBarNavigationPane : TutorialControl {
		...
		private void frmNavBarNavigationPane_Load(object sender, System.EventArgs e) {
		...
		void InitControls() {
            ...
            splitter1.LocationChanged += new EventHandler(splitter1_LocationChanged);
		...
		private void navBarControl1_ActiveGroupChanged(object sender, DevExpress.XtraNavBar.NavBarGroupEventArgs e) {
			ActiveGropChanged(e.Group.Caption, e.Group.LargeImageIndex);
		...
		void ActiveGropChanged(string caption, int index) {
			label1.Text = caption;
		...
		private void treeView1_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e) {
			...
			for(int i = 0; i < navBarControl1.Groups.Count; i++)
				if(navBarControl1.Groups[i].Caption == action) {
					ActiveGropChanged(action, navBarControl1.Groups[i].LargeImageIndex);
					ShowPanel(action);
					break;
				}
		}
