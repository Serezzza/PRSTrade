...
namespace DevExpress.XtraNavBar.Demos {
	public partial class frmNavBarProperties : TutorialControl {
		...
		private void InitOptions() {
			chbAllowSelectedLink.Checked = navBarControl1.AllowSelectedLink;
		...
		private void chbAllowSelectedLink_CheckedChanged(object sender, System.EventArgs e) {
			navBarControl1.AllowSelectedLink = chbAllowSelectedLink.Checked;		
		}
		...
		private void biLinkProperties_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
			frmLinkProperties dlg = new frmLinkProperties(menuPoint, selectedGroup, selectedLink, navBarControl1.Items, imageList1, imageList2);
			dlg.ShowDialog();
		}
