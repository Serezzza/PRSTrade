...
namespace DevExpress.XtraNavBar.Demos {
	public partial class frmLinkProperties : DevExpress.XtraEditors.XtraForm {
		public frmLinkProperties(Point location, NavBarGroup group, NavBarItemLink link, NavItemCollection items, ImageList imlL, ImageList imlS) {
			InitializeComponent();
        ...
        private ImageList imlLarge, imlSmall;
